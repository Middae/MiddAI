...
DEFAULT_SETTINGS = {
    ...
    "depth": {
        ...
        "instant": {
            ...
            "style_instruction": "Answer in one direct sentence or one very short paragraph. Do not add extra sections, examples, or follow-up questions unless the user asks for them.",
        },
        "quick": {
            "max_results": 8,
            "max_good_sources": 2,
            ...
            "style_instruction": "Answer in one small paragraph. Be direct and avoid lists unless the user asks for them.",
        },
        "balanced": {
            "max_results": 20,
            "max_good_sources": 3,
            ...
            "style_instruction": "Answer clearly in up to three short paragraphs. Include the useful detail, but keep it easy to scan.",
        },
        "deep": {
            "max_results": 35,
            "max_good_sources": 5,
...
# Current memory is visible to the prompt for this many minutes.
...
[depth.instant]
# Fastest mode.
# Chat: one sentence or one very short paragraph.
...
MEMORY_CURRENT_EXPIRE_HOURS = SETTINGS["memory"].get("current_memory_expire_hours", 4)
...
DEFAULT_DEPTH = RAW_DEFAULT_DEPTH if RAW_DEFAULT_DEPTH in DEPTH_PRESETS else "balanced"
