...
def show_new_user_recommendation(root, choice, selected):
    ...
    recommendation = MODEL_OPTIONS[NEW_USER_RECOMMENDATION_MODEL_INDEX]
...
def choose_model(model_statuses=None):
    ...
    model_groups = [
        {
            ...
            "requirements": (
                ...
                "4B/3B OPTIONS USE AI JUDGE MEMORY."
            ),
            "options": [0, 1, 2, 3],
        },
        {
    ...
    def add_model_card(parent_frame, index):
        ...
        if option.get("image_analysis"):
            add_rainbow_text(card, bg=panel_bg, padx=24, pady=(2, 2))
        ...
        if option.get("custom_loaded_model"):
            ...
            detail_text = (
                ...
                f"MIN CONTEXT: {get_min_context_length(option)} TOKENS\n"
                f"MAX CONTEXT: {get_max_context_length(option)} TOKENS\n"
