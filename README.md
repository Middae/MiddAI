...
It also includes a built-in memory system, allowing the assistant to remember useful information between chats.
...
Download MiddAI, extract the folder, download LM Studio (https://lmstudio.ai/download), open LM Studio once, then run MiddAI.exe.
